...
import { DigitalCapabilityWorkspace } from './DigitalCapabilityWorkspace';
...
export const OwnerControlCenterLaunchpad: React.FC<OwnerControlCenterLaunchpadProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'products' | 'workspaces' | 'capabilities' | 'pillars'>('products');
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-6 md:space-y-8 font-sans pb-24">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 pb-4">
        <div className="flex items-center gap-2">
          ...
          >
            <Layers className="w-4 h-4" />
            <span>Digital Module Workspace</span>
          </button>
      ...
      {/* View 0.5: Digital Module Workspace */}
      {activeTab === 'capabilities' && (
        <div className="space-y-6">
          <div className="bg-indigo-50/60 border border-indigo-200 rounded-xl p-4 flex items-center justify-between">
            <div className="text-xs text-indigo-900 font-medium">
              <span className="font-bold">Digital Module Workspace:</span> Authoritative dynamic execution fabric mapping sovereign products to their active registered capabilities, roles, inputs, workflows, and integrations.
            </div>
          </div>
          <DigitalCapabilityWorkspace />
        </div>
      )}
