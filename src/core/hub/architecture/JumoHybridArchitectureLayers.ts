...
const INITIAL_JUMO_HYBRID_ARCHITECTURE_LAYERS: JumoArchitectureLayer[] = [
  ...
  L("L093", "AI & Workforce", "Engineering Workforce Router", "Allocates specialized AI engineering agents to active manufacturing and testing tasks.", "engineering", ["L089"], "ACTIVE", false, true),
