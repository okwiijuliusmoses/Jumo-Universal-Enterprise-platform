...
export class JumoSecretVault {
  ...
  public getOpenAIKey(): string {
    ...
    return (env.JUMO_OPENAI_API_KEY || env.OPENAI_API_KEY || "").trim();
  }

  public getGeminiKey(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return (env.JUMO_GEMINI_API_KEY || env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY || "").trim();
  }

  public getCopilotKey(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return (env.JUMO_COPILOT_API_KEY || env.COPILOT_API_KEY || "").trim();
  }

  public getAnthropicKey(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return (env.JUMO_ANTHROPIC_API_KEY || env.ANTHROPIC_API_KEY || env.CLAUDE_API_KEY || "").trim();
  }

  public getSecretEncryptionKey(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_SECRET_ENCRYPTION_KEY || "";
  }

  public getSessionSecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_SESSION_SECRET || "";
  }

  public getJwtSecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_JWT_SECRET || "";
  }

  public getInternalServiceSecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_INTERNAL_SERVICE_SECRET || "";
  }

  public getProviderRequestSigningSecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_PROVIDER_REQUEST_SIGNING_SECRET || "";
  }

  public getProviderWebhookSecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_PROVIDER_WEBHOOK_SECRET || "";
  }

  public getDigitalPayIdentitySecret(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_DIGITAL_PAY_IDENTITY_SECRET || env.DIGITAL_PAY_IDENTITY_SECRET || "JUMO-DEVELOPMENT-IDENTITY-SECRET-CHANGE-ME-32";
  }
  ...
  public getAIProviderMode(): "LIVE" | "HYBRID" | "AIR-GAP" {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_PROVIDER_MODE || "HYBRID";
  ...
  public getAIReasoningPolicy(): "CRITICAL_ARCH_PREFER_OPENAI" | "COST_SENSITIVE" | "BALANCED" {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_REASONING_POLICY || "BALANCED";
  ...
  public getOpenAIModel(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_OPENAI_MODEL || "gpt-5.6-sol";
  }

  public getGeminiModel(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_GEMINI_MODEL || "gemini-3.6-flash";
  }

  public getCopilotProviderEndpoint(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_COPILOT_PROVIDER_ENDPOINT || "";
  }

  public getCopilotModel(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_COPILOT_MODEL || "copilot-intelligent-mesh";
  }

  public getAITimeoutMs(): number {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_TIMEOUT_MS || "30000";
    return parseInt(val, 10) || 30000;
  }

  public getAIMaxRetries(): number {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_MAX_RETRIES || "3";
    return parseInt(val, 10) || 3;
  }

  public getAIMaxConcurrency(): number {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_MAX_CONCURRENCY || "5";
    return parseInt(val, 10) || 5;
  }

  public getAIFallbackEnabled(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_FALLBACK_ENABLED;
  ...
  public getAIExternalProviderRequired(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_EXTERNAL_PROVIDER_REQUIRED;
  ...
  public getAIProviderHealthCheckEnabled(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_AI_PROVIDER_HEALTH_CHECK_ENABLED;
    if (val === undefined) return true;
    return val === "true";
  }
  ...
  public getManufacturingAutoTransition(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_MANUFACTURING_AUTO_TRANSITION;
    if (val === undefined) return true;
    return val === "true";
  }
  ...
  public getManufacturingHumanGatesEnforced(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_MANUFACTURING_HUMAN_GATES_ENFORCED;
    if (val === undefined) return true;
    return val === "true";
  }
  ...
  public getSovereignLedgerEnabled(): boolean {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_SOVEREIGN_LEDGER_ENABLED;
    if (val === undefined) return true;
    return val === "true";
  }
  ...
  public getUniversalAiProvider(): string {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    return env.JUMO_UNIVERSAL_AI_PROVIDER || "openai";
  }
  ...
  public getRepositoryRoot(): string {
    ...
    try {
      ...
      if (typeof process !== "undefined" && typeof process.cwd === "function") {
        ...
        return (process.env && process.env.JUMO_REPOSITORY_ROOT) || nodePath.resolve(cwd);
      }
    } catch (e) {}
  ...
  public getArchitectureExpansionLevel(): "MIN" | "BALANCED" | "MAX" {
    const env = (typeof process !== "undefined" && process.env) ? process.env : {};
    const val = env.JUMO_ARCHITECTURE_EXPANSION_LEVEL || "MAX";
