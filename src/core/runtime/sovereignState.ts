...
export class SovereignOperatingStateService {
  ...
  public static promoteManufacturingJob(jobId: string, actor: string) {
    ...
    const legacyMap: Record<string, ManufacturingJobStatus> = {
      ...
      'NORMALIZING': 'REQUIREMENTS_NORMALIZATION',
      'SECURITY_HARDENING': 'SECURITY_CLASSIFICATION',
      'DEPENDENCIES_RESOLVING': 'DEPENDENCY_RESOLUTION',
      'AI_ASSIGNED': 'AI_WORKFORCE_ASSIGNMENT',
      'COMPILING': 'COMPILING_BUILDING',
      'INFRASTRUCTURE_ASSEMBLING': 'INFRASTRUCTURE_DESIGN',
      'VERIFYING': 'UNIT_TESTING',
      'SECURITY_COMPLIANCE_VERIFYING': 'SECURITY_VERIFICATION',
      'INTEGRATION_VERIFYING': 'INTEGRATION_TESTING',
      'SYSTEM_VERIFYING': 'SYSTEM_E2E_VERIFICATION',
      'CERTIFYING': 'CERTIFICATION_ACCEPTANCE',
      'DEPLOYING': 'PRODUCTION_DEPLOYMENT'
    };
