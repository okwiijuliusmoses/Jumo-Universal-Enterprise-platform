...
export const resolveModuleDataSummary = (moduleId: string) => {
  return {
    ...
    kpis: [
      { title: 'Total Enrolled Learners', value: '1,450', change: '+5.4%' },
      { title: 'Daily Attendance', value: '96.2%', change: '+1.1%' },
      { title: 'P.7 PLE Candidates', value: '210', change: '0%' },
      { title: 'Tuition Collections', value: '88.5%', change: '+4.2%' }
    ]
  };
};
