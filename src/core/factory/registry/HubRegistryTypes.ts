...
export type ManufacturingJobStatus =
  ...
  | 'REQUIREMENTS_NORMALIZATION' | 'INSTANCE_DEFINED' | 'ARCHITECTURE_RESOLVING' | 'CONTRACT_GENERATED'
  | 'GOVERNANCE_POLICY_MAPPING' | 'SECURITY_CLASSIFICATION' | 'INTEGRATION_CONTRACTING' | 'EXPERIENCE_SPECIFICATION'
  | 'AI_WORKFORCE_ASSIGNMENT' | 'LAYERS_ASSEMBLING' | 'INFRASTRUCTURE_DESIGN' | 'ARTIFACT_GENERATION'
  | 'COMPILING_BUILDING' | 'STATIC_SUPPLY_CHAIN_ANALYSIS' | 'UNIT_TESTING' | 'SECURITY_VERIFICATION'
  | 'PERFORMANCE_RESILIENCE_TESTING' | 'SYSTEM_E2E_VERIFICATION' | 'COMPLIANCE_VERIFICATION' | 'CERTIFICATION_ACCEPTANCE'
  | 'RELEASE_CANDIDATE' | 'PRODUCTION_DEPLOYMENT' | 'PRODUCTION_VERIFICATION' | 'PUBLISHING_ACTIVATION' | 'RUNTIME_ACTIVE' | 'CONTINUOUS_OPERATIONS'
