...
export default function App() {
  ...
  return (
    <UEOSErrorBoundary componentName="JUMO Universal Operating Environment">
      {!currentUser ? (
        <PublicGateway onLoginSuccess={handleLogin} />
      ) : (
        <UEOSShell user={currentUser} onLogout={handleLogout} />
      )}
    </UEOSErrorBoundary>
  );
}
