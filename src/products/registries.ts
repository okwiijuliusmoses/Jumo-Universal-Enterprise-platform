...
// 1. Authoritative JUMO Independent ERP Products Family (Single source of truth via ApprovedProductRegistry)
import { ApprovedProductRegistry } from './ApprovedProductRegistry';
export const ProductRegistry: ProductDefinition[] = ApprovedProductRegistry.map(p => ({
  id: p.id,
  name: p.name,
