...
export class FaapService {
  ...
  private bills: FaapVendorBill[] = [
    { id: 'b1', billNumber: 'BIL-2026-001', vendorName: 'Uganda Telecom Hub', dueDate: '2026-09-15', totalAmount: 450000, balanceDue: 450000, status: 'OPEN' },
    { id: 'b2', billNumber: 'BIL-2026-002', vendorName: 'Power Grid Co.', dueDate: '2026-09-10', totalAmount: 850000, balanceDue: 0, status: 'PAID' }
  ];

  // Accounts Receivable Subledger
  private invoices: FaapCustomerInvoice[] = [
    { id: 'i1', invoiceNumber: 'INV-2026-001', customerName: 'St. Marys High-School', dueDate: '2026-09-20', totalAmount: 1800000, balanceDue: 1800000, status: 'SENT' },
    { id: 'i2', invoiceNumber: 'INV-2026-002', customerName: 'Kampala Junior Academy', dueDate: '2026-09-05', totalAmount: 2400000, balanceDue: 0, status: 'PAID' }
  ];

  // Bank Feed Statements Subledger
  private bankFeeds: FaapBankFeedTransaction[] = [
    { id: 'bf1', date: '2026-08-10', description: 'DIRECT DEPOSIT MTN MO-MO TRANS', amount: 350000, status: 'UNRECONCILED' },
    { id: 'bf2', date: '2026-08-11', description: 'OFFICE SUPPLIES OUTLET PAY', amount: -150000, status: 'UNRECONCILED' },
    { id: 'bf3', date: '2026-08-12', description: 'INTEREST CREDIT BANK ROYAL', amount: 5000, status: 'MATCHED' }
  ];
