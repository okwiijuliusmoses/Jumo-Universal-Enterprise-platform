        ...
        <JumoDataTable
          ...
          columns={[
            ...
            { header: 'Debit', accessor: (j) => (
              <span className="font-mono font-bold text-slate-900">{j.totalDebit.toLocaleString()}</span>
            ), className: 'text-right' },
            { header: 'Credit', accessor: (j) => (
              <span className="font-mono font-bold text-slate-900">{j.totalCredit.toLocaleString()}</span>
            ), className: 'text-right' },
        ...
        <JumoDataTable
          ...
          columns={[
            ...
            { header: 'Balance', accessor: (a) => (
              <span className="font-mono font-bold text-slate-900">{a.balance.toLocaleString()} {a.currency}</span>
            ), className: 'text-right' }
          ]}
        />
        ...
        <JumoDataTable
          ...
          columns={[
            ...
            { header: 'Cash (UGX)', accessor: (e) => (
              <span className="font-mono text-slate-900">{e.cashAmount.toLocaleString()}</span>
            ), className: 'text-right' },
            { header: 'Bank (UGX)', accessor: (e) => (
              <span className="font-mono text-slate-900">{e.bankAmount.toLocaleString()}</span>
            ), className: 'text-right' }
          ]}
        />
