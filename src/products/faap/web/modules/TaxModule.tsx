          ...
          <tbody className="divide-y divide-slate-100">
            {taxPeriods.map((t) => (
              <tr key={t.period} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="px-6 py-4 text-right font-mono text-slate-700">{formatNumber(t.vatCollected)}</td>
                <td className="px-6 py-4 text-right font-mono text-blue-600 font-bold">{formatNumber(t.vatPaidInput)}</td>
                <td className="px-6 py-4 text-right font-mono text-rose-600 font-black">{formatNumber(t.netVatPayable)}</td>
                <td className="px-6 py-4 text-right font-mono text-slate-900 font-bold">{formatNumber(t.wht6Percent)}</td>
