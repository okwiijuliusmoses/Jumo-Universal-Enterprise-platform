    ...
    <div className="space-y-6 animate-in fade-in duration-300 pb-16">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm">Sovereign FAAP-compliant spot exchange rates, foreign currency transactions & realized/unrealized FX gain/loss revaluation.</p>
        </div>
        <button 
          ...
          <tbody className="divide-y divide-slate-100">
            {currencies.map((curr) => (
              <tr key={curr.code} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="px-6 py-4 text-right font-mono font-bold text-emerald-700 text-base">{formatNumber(curr.spotRateToUGX)} UGX</td>
