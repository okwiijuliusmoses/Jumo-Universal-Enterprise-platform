...
export const EducationDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Total Budget Head Allocation', value: `${((totalAllocation ?? 0) / 1000000).toFixed(1)}M UGX`, icon: GraduationCap, color: 'text-emerald-600', bg: 'bg-emerald-100', trend: 'Vote Book Secured' },
