import { Building2, Users, Landmark, BookOpen, Clipboard, DollarSign, Activity, Zap, Church, Heart, Globe, ShieldCheck, Layers, Sparkles } from 'lucide-react';

export type ErpOfficeDefinition = ErpOffice;
export type ErpDepartmentDefinition = ErpDepartment;
...
export const ErpOrganizationalRegistry: ErpProductStructure[] = [
  ...
  },
  {
    ...
    departments: [
      {
        id: 'DEPT_CTRL_GOV', name: 'Governance & Security', type: 'GOVERNANCE',
        offices: [
          { id: 'OFF_CTRL_SECURITY', name: 'AEGIS Security', type: 'GOVERNANCE', icon: ShieldCheck, portalId: 'PORTAL_CTRL_SECURITY', description: 'Zero-trust infrastructure control.' },
          { id: 'OFF_CTRL_TENANTS', name: 'Tenant Management', type: 'GOVERNANCE', icon: Users, portalId: 'PORTAL_CTRL_TENANTS', description: 'Multi-tenant isolation and scaling.' }
        ]
      },
      {
        id: 'DEPT_CTRL_AI', name: 'Intelligence & Core', type: 'INTELLIGENCE',
        offices: [
          { id: 'OFF_CTRL_AI', name: 'AI Command Center', type: 'INTELLIGENCE', icon: Sparkles, portalId: 'PORTAL_CTRL_AI', description: 'Agent registry and model routing.' },
          { id: 'OFF_CTRL_STORE', name: 'Platform Store', type: 'OPERATIONS', icon: Layers, portalId: 'PORTAL_CTRL_STORE', description: 'Module extensions and marketplace.' }
        ]
      },
      {
        id: 'DEPT_CTRL_INFRA', name: 'Infrastructure Ops', type: 'INFRASTRUCTURE',
        offices: [
          { id: 'OFF_CTRL_CLOUD', name: 'Cloud & Compute', type: 'OPERATIONS', icon: Activity, portalId: 'PORTAL_CTRL_CLOUD', description: 'Cluster health and node monitoring.' }
        ]
      }
    ]
  }
