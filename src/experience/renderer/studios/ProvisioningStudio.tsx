                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-6">
                  ...
                  {activeInstallation.commissioning && (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {(Array.isArray(activeInstallation?.commissioning?.checksPerformed) ? activeInstallation.commissioning.checksPerformed : []).map((chk: any, i: number) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-slate-900 text-slate-300 font-mono text-[11px] rounded-xl space-y-1 max-h-48 overflow-auto">
                      {(Array.isArray(activeInstallation?.logs) ? activeInstallation.logs : []).map((log: string, idx: number) => (
