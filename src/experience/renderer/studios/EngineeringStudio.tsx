                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-slate-800/40 rounded-2xl p-6 border border-slate-700/50 space-y-4">
                      ...
                      <div className="space-y-3">
                        {selectedJob.engineeringReport.expansion.domainDecomposition.map((d: string, i: number) => (
                    ...
                    <div className="bg-slate-800/40 rounded-2xl p-6 border border-slate-700/50 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedJob.engineeringReport.architecture.layers.map((l: string, i: number) => (
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-700/50">
                          {selectedJob.engineeringReport.components.map((c: any, i: number) => (
                            <tr key={i}>
