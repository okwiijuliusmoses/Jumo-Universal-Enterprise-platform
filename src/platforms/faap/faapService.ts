...
export class FAAPService {
  ...
  public performReconciliation(tenantId: string): ReconciliationReport {
    ...
    console.log(`[FAAP_RECONCILIATION] Ledger reconciliation executed for tenant ${tenantId}. Status: ${report.status}. Debits: ${totalDebits.toFixed(2)}, Credits: ${totalCredits.toFixed(2)}.`);
    return report;
  }
