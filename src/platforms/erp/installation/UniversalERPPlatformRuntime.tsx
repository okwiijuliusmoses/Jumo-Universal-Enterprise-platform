                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className={`p-1.5 rounded-lg text-center font-mono font-bold text-sm ${faapDebit - faapCredit === 0 ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
                          ${(faapDebit - faapCredit).toFixed(2)}
                        </div>
                      </div>
                    </div>
                        ...
                        <tbody className="divide-y text-slate-700">
                          {ledgerEntries.map((item, idx) => (
                            <tr key={idx} className="hover:bg-slate-50 font-mono text-[11px]">
                              ...
                              <td className="p-3 text-right text-emerald-600 font-bold">${item.debit.toLocaleString()}</td>
                              <td className="p-3 text-right text-emerald-600 font-bold">${item.credit.toLocaleString()}</td>
                              <td className="p-3 text-right text-amber-600 font-bold">${item.fee.toFixed(2)}</td>
