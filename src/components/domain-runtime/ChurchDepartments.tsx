...
export const ChurchDepartments: React.FC = () => {
  ...
  const handlePostLedger = (e: React.FormEvent) => {
    ...
    alert(`Entry posted successfully. 1.5% Settlement Clearing Fee of $${computedFee.toFixed(2)} applied and routed to central JUMO Master Treasury.`);
  };
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
                    ...
                    <strong className="text-xl font-bold text-indigo-700 block mt-1 font-mono">{((activeDept.budgetSpent / activeDept.budgetAllocated) * 100).toFixed(1)}%</strong>
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs lg:col-span-2 space-y-4">
                  <div className="flex justify-between items-center border-b pb-2">
                    ...
                    <div className="text-right">
                      ...
                      <strong className="text-emerald-700 font-mono text-[13px] font-bold">+${financialTotals.fees.toFixed(2)}</strong>
                    </div>
                  </div>
                    ...
                    {financialTotals.activeEntries.map(entry => (
                      <div key={entry.id} className="p-3 bg-slate-50/70 border rounded-lg flex justify-between items-center text-xs hover:bg-slate-50 transition-all">
                        ...
                        <div className="text-right shrink-0">
                          ...
                          <span className="text-[10px] text-emerald-600 font-mono mt-0.5 block">Clearing Fee: ${entry.clearingFee.toFixed(2)}</span>
                        </div>
                      </div>
                    ))}
                  </div>
