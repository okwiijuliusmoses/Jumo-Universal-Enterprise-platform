              ...
              <tbody className="divide-y divide-slate-100 font-mono text-xs">
                {clergy.map(clg => (
                  <tr key={clg.id} className="hover:bg-slate-50">
                    ...
                    <td className="py-3 px-3 text-right font-bold">{formatMoney(clg.pensionVolume, '$')}</td>
                    <td className="py-3 px-3 text-right font-bold text-emerald-700">{formatMoney(clg.welfareAllocated, '$')}</td>
