          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
                ...
                <strong className="text-2xl font-bold text-slate-900 block mt-1">{((provincialStats?.activeSouls ?? 0) / 1000000).toFixed(1)}M Souls</strong>
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
                ...
                <strong className="text-2xl font-bold text-slate-900 block mt-1">${((provincialStats?.annualBudgetPool ?? 0) / 1000000).toFixed(1)}M USD</strong>
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
                ...
                <strong className="text-2xl font-bold text-emerald-700 block mt-1">{formatMoney(provincialStats.totalClearingFeesCollected, '$')}</strong>
              ...
              <div className="space-y-2">
                {dioceses.map(dio => (
                  ...
                  >
                    ...
                    <span className="text-slate-600 mt-0.5 block">Active Souls: {formatNumber(dio.activeSouls)}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4 lg:col-span-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div className="p-3 bg-slate-50 rounded-lg border">
                  ...
                  <strong className="text-slate-900 block text-sm mt-0.5">{formatNumber(selectedDiocese.activeSouls)}</strong>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg border">
                  <span className="text-slate-500 block">Annual Budget</span>
                  <strong className="text-slate-900 block text-sm mt-0.5">{formatMoney(selectedDiocese.annualBudget, '$')}</strong>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg border">
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-emerald-50 text-emerald-950 rounded-xl border border-emerald-200">
                  ...
                  <strong className="text-xl font-bold text-emerald-800 block mt-1">{formatMoney(provincialStats.totalClearingFeesCollected, '$')}</strong>
