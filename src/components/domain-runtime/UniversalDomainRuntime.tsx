                      ...
                      <tbody className="divide-y divide-slate-100 font-mono">
                        {doubleEntryPostings.map(jnl => (
                          <tr key={jnl.id} className="hover:bg-slate-50">
                            ...
                            <td className="py-2 px-2 text-right font-bold text-emerald-700 align-top">${jnl.amount.toLocaleString()}.00</td>
                            <td className="py-2 px-2 text-right font-bold text-slate-700 align-top">${jnl.amount.toLocaleString()}.00</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
