...
export default function RuntimeConsole({ blueprintName }: RuntimeConsoleProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden flex flex-col min-h-[680px] shadow-2xl font-sans text-slate-900">
      ...
      <div className="bg-white/60 border-b border-slate-200/80 px-6 py-2.5 flex flex-wrap gap-1">
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "kernel" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "registries" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "security" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "faap" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "automation" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "ai" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-2 transition ${
            activeConsoleTab === "domains" ? "bg-white text-emerald-400 border border-slate-200/60" : "text-slate-600 hover:text-slate-200"
          }`}
        >
        ...
        {activeConsoleTab === "kernel" && (
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            ...
            <div className="flex border-b border-slate-200 pb-2 gap-4">
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition ${
                  kernelSubTab === "diagnostics" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
                Kernel Diagnostics
              </button>
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition ${
                  kernelSubTab === "lifecycle" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition ${
                  kernelSubTab === "featureflags" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
            ...
            {kernelSubTab === "diagnostics" && (
              <div className="space-y-6 flex-1 flex flex-col">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="bg-white/40 p-4 rounded-2xl border border-slate-850 flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl ${bootData ? "bg-emerald-500/10 text-emerald-400" : "bg-white text-slate-500"}`}>
                  ...
                  <div className="bg-white/40 p-4 rounded-2xl border border-slate-850 flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl ${bootData ? "bg-cyan-500/10 text-[#0078D4]" : "bg-white text-slate-500"}`}>
                  ...
                  <div className="bg-white/40 p-4 rounded-2xl border border-slate-850 flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl ${bootData ? "bg-indigo-500/10 text-[#0078D4]" : "bg-white text-slate-500"}`}>
                  ...
                  <div className="bg-white/40 p-4 rounded-2xl border border-slate-850 flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl ${bootData ? "bg-pink-500/10 text-pink-400" : "bg-white text-slate-500"}`}>
                ...
                <div className="flex-1 flex flex-col bg-white rounded-2xl border border-slate-850 overflow-hidden font-mono text-xs">
                  <div className="bg-white px-4 py-2 flex justify-between items-center border-b border-slate-850">
                    <span className="text-slate-600 text-[10px] flex items-center gap-1.5 uppercase font-bold tracking-wider">
                  ...
                  <div className="p-4 flex-1 overflow-y-auto space-y-1.5 text-slate-700 max-h-[260px]">
                ...
                <div className="flex justify-between items-center bg-white/30 p-4 rounded-xl border border-slate-850/60">
                  <span className="text-slate-600 text-[11px] leading-relaxed max-w-lg">
            ...
            {kernelSubTab === "lifecycle" && (
              <div className="space-y-6 flex-1 flex flex-col">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  {/* Service State List */}
                  <div className="lg:col-span-8 bg-white/30 border border-slate-850 rounded-2xl p-5 flex flex-col justify-between">
                    <div>
                    ...
                    <div className="space-y-2.5">
                      {services.map(svc => (
                        <div key={svc.id} className="bg-white border border-slate-850/60 p-3 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-xs font-bold text-slate-900 flex items-center gap-1.5 font-mono">
                                ...
                                <span className="text-slate-700 font-sans">{svc.name}</span>
                              </div>
                              <div className="text-[10px] text-slate-500 flex items-center gap-2 mt-0.5">
                                ...
                                <span>Memory Limit: <strong className="text-slate-600 font-mono">{svc.memory}</strong></span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
                            <button
                              ...
                              className={`px-3 py-1 rounded text-[10px] font-bold uppercase transition ${
                                svc.state === "Running" 
                                  ? "bg-white text-red-400 hover:bg-slate-100 border border-red-500/25" 
                                  : "bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/35 border border-emerald-200"
                              }`}
                            >
                  ...
                  <div className="lg:col-span-4 bg-white/40 border border-slate-850 p-5 rounded-2xl flex flex-col">
                    ...
                    <div className="flex-1 mt-6 border border-slate-850/80 rounded-xl p-4 bg-white text-[10px] font-mono space-y-4">
                      <div className="flex items-center gap-1.5">
                        <span className="text-emerald-400">[OS KERNEL]</span>
                        <ArrowRight className="h-3 w-3 text-slate-600" />
                        <span className="text-slate-700">Identity Container</span>
                      </div>
                      ...
                      <div className="pl-6 border-l border-slate-200 space-y-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <ArrowRight className="h-3 w-3 text-slate-600" />
                          <span className="text-slate-700">Double Entry validation</span>
                        </div>
                        
                        <div className="pl-6 border-l border-slate-200 space-y-2">
                          <div className="flex items-center gap-1.5">
                            <span className="text-slate-500">├──</span>
                            <span className="text-[#0078D4]">SACCO_ERP_Core</span>
                            <span className="text-slate-500 text-[8px]">(Lending Limits)</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <span className="text-slate-500">└──</span>
                            <span className="text-[#0078D4]">Church_ERP_Module</span>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <ArrowRight className="h-3 w-3 text-slate-600" />
                          <span className="text-slate-700">Gemini 3.5 API Gate</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {kernelSubTab === "featureflags" && (
              <div className="bg-white/20 border border-slate-850 rounded-2xl p-6 flex-1 flex flex-col justify-between">
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white border border-slate-850 p-4 rounded-xl flex items-center justify-between">
                    <div>
        ...
        {activeConsoleTab === "registries" && (
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              {/* Form Side */}
              <div className="w-full lg:w-4/12 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4">
                <div>
                ...
                <form onSubmit={handleAddRegistry} className="space-y-3.5">
                  <div>
                    <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Module Namespace / Code</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500 font-mono"
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Registry Type</label>
                      <select
                        value={newModuleType}
                        onChange={(e) => setNewModuleType(e.target.value)}
                        className="w-full bg-white border border-slate-200 rounded-lg px-2 py-2 text-xs focus:outline-none focus:border-emerald-500 cursor-pointer"
                      >
                    ...
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Tenant context</label>
                      <select
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Module Version</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Permissions Scope</label>
                      <select
                  ...
                  <button
                    type="submit"
                    className="w-full bg-white hover:bg-slate-100 text-slate-900 font-bold py-2 rounded-lg text-xs flex items-center justify-center gap-1.5 transition cursor-pointer border border-slate-200 shadow"
                  >
              ...
              <div className="flex-1 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between min-h-[350px]">
                <div>
                      ...
                      {["All", "Domain", "Service", "Security", "AI", "Module"].map(f => (
                        <button
                          ...
                          className={`px-2 py-1 rounded-md font-semibold transition ${
                            registryFilter === f ? "bg-white text-emerald-400" : "text-slate-600 hover:text-slate-200"
                          }`}
                        >
                          {f}
                        </button>
                  ...
                  <div className="space-y-2 max-h-[240px] overflow-y-auto pr-1">
                    {filteredRegistries.length === 0 ? (
                      ...
                      filteredRegistries.map((mod, i) => (
                        <div key={i} className="bg-white border border-slate-850/60 p-3 rounded-xl flex items-center justify-between gap-4 hover:border-slate-200 transition">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <span className="text-[9px] font-mono bg-white text-slate-600 px-2 py-0.5 rounded border border-slate-850">
                              {mod.version}
                            </span>
                            <span className="text-[9px] font-mono bg-white text-emerald-700 px-2.5 py-0.5 rounded-full border border-emerald-950/60 uppercase">
                              {mod.type}
                            </span>
                          </div>
                        </div>
          ...
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            ...
            <div className="flex border-b border-slate-200 pb-2 gap-4">
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition ${
                  faapSubTab === "journal" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition ${
                  faapSubTab === "trialbalance" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
            ...
            {faapSubTab === "journal" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
                ...
                {/* Journal Sheet Form */}
                <div className="lg:col-span-5 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4 flex flex-col justify-between">
                  <div>
                  ...
                  <form onSubmit={handlePostTransaction} className="space-y-3.5 my-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Target Account</label>
                        <select
                          value={selectedAccount}
                          onChange={(e) => setSelectedAccount(e.target.value)}
                          className="w-full bg-white border border-slate-850 rounded-lg px-2.5 py-2 text-xs focus:outline-none focus:border-emerald-500 cursor-pointer"
                        >
                          {accounts.map(acc => (
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Counter Balance Account</label>
                        <select
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Debit Amount ($)</label>
                        <input
                          type="number"
                          placeholder="0.00"
                          value={debitValue}
                          ...
                          className="w-full bg-white border border-slate-850 rounded-lg px-2.5 py-2 text-xs focus:outline-none focus:border-emerald-500 font-mono"
                        />
                      </div>

                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Credit Amount ($)</label>
                        <input
                          type="number"
                          placeholder="0.00"
                          value={creditValue}
                    ...
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Journal Description / Memo</label>
                      <input
                        type="text"
                        value={narration}
                        onChange={(e) => setNarration(e.target.value)}
                        className="w-full bg-white border border-slate-850 rounded-lg px-2.5 py-2 text-xs focus:outline-none focus:border-emerald-500"
                      />
                    </div>
                ...
                <div className="lg:col-span-7 space-y-4 flex flex-col justify-between">
                  ...
                  <div className="bg-white/30 p-4 rounded-2xl border border-slate-850">
                    <h5 className="text-[10px] font-mono font-bold text-slate-600 uppercase mb-3">FAAP Consolidated Accounts Balances</h5>
                    {loadingAccounts ? (
                      <div className="text-center py-6 text-xs text-slate-500">Retrieving balances from ledger service...</div>
                    ) : (
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        {accounts.map(acc => (
                          <div key={acc.code} className="bg-white border border-slate-850 p-2.5 rounded-xl">
                  ...
                  <div className="bg-white/40 p-4 rounded-2xl border border-slate-850 flex-1 flex flex-col min-h-[180px]">
                    <h5 className="text-[10px] font-mono font-bold text-slate-600 uppercase mb-3">Consolidated General Ledger Journal Activity</h5>
                    <div className="flex-1 overflow-y-auto max-h-[160px] space-y-2 pr-1 font-mono text-[10px]">
                      {ledgerLogs.map((entry, idx) => (
                        <div key={idx} className="bg-white border border-slate-850 p-2.5 rounded-xl flex flex-col md:flex-row justify-between gap-2">
                          <div>
                            <div className="flex items-center gap-1.5">
                              <span className="text-[9px] bg-white border border-slate-200 text-slate-600 px-1 py-0.5 rounded">ID: #{entry.id}</span>
                              <span className="text-slate-900 font-semibold">{entry.narration}</span>
                            </div>
                            <div className="text-slate-500 text-[9px] mt-0.5">
                              Contra posting matches <span className="text-slate-700 font-bold">{entry.account}</span> with balancing <span className="text-slate-700 font-bold">{entry.balancingAccount}</span>
                            </div>
                          </div>
                          <div className="flex items-center gap-3 justify-between md:justify-end shrink-0 border-t md:border-t-0 border-slate-850/60 pt-1.5 md:pt-0">
                            {entry.debit > 0 && <span className="text-emerald-400 font-bold">DR: +{formatMoney(entry.debit, '$')}</span>}
                            {entry.credit > 0 && <span className="text-amber-500 font-bold">CR: -{formatMoney(entry.credit, '$')}</span>}
            ...
            {faapSubTab === "trialbalance" && (
              <div className="bg-white/20 border border-slate-850 p-5 rounded-2xl flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-start border-b border-slate-850 pb-3">
                    ...
                    <div className="flex gap-2">
                      <span className="text-[10px] font-mono bg-white border border-slate-200 text-slate-600 px-2.5 py-0.5 rounded">
                  ...
                  <div className="my-4 overflow-y-auto max-h-[220px] border border-slate-850 rounded-xl">
                    <table className="w-full text-[11px] font-mono border-collapse">
                      <thead>
                        <tr className="bg-white border-b border-slate-850 text-slate-600 text-left">
                      ...
                      <tbody>
                        {trialBalance?.items?.map(item => (
                          <tr key={item.code} className="border-b border-slate-850/60 hover:bg-white/40 text-slate-700">
                            <td className="p-3 font-semibold text-slate-600">{item.code}</td>
                            <td className="p-3 font-sans text-slate-200">{item.name}</td>
                            <td className="p-3">
                              <span className="text-[10px] bg-white px-1.5 py-0.5 rounded text-slate-600 border border-slate-850">{item.category}</span>
                            </td>
                            <td className="p-3 text-right text-emerald-400">{item.debit > 0 ? formatMoney(item.debit, '$') : "-"}</td>
                            <td className="p-3 text-right text-amber-500">{item.credit > 0 ? formatMoney(item.credit, '$') : "-"}</td>
                          </tr>
                        ))}
                        <tr className="bg-white/50 border-t border-slate-200 font-bold text-slate-900">
                          <td colSpan={3} className="p-3 text-right uppercase text-[10px] tracking-wider">Consolidated Sum Totals</td>
                          <td className="p-3 text-right text-emerald-400 text-xs">{formatMoney(trialBalance?.totalDebits, '$')}</td>
                          <td className="p-3 text-right text-amber-500 text-xs">{formatMoney(trialBalance?.totalCredits, '$')}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
        ...
        {activeConsoleTab === "security" && (
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
              ...
              <div className="lg:col-span-5 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4">
                <div>
                  <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
                ...
                {currentUserProfile && (
                  <div className="space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-slate-850">
                    ...
                    {/* Tenant selector */}
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Simulate Tenant Context Selection</label>
                      <select
                        ...
                        className="w-full bg-white border border-slate-850 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500 cursor-pointer"
                      >
                    ...
                    <div className="bg-white/60 p-3.5 rounded-xl border border-slate-850 font-mono text-[10px] space-y-1.5 text-slate-600">
                      <div>SANDBOX STATE: <span className="text-emerald-400 font-bold">STRICT_ISOLATED</span></div>
                      <div>CONTEXT LEVEL: <span className="text-[#0078D4] font-bold">{currentUserProfile.trustLevel}</span></div>
                      <div className="truncate">JWT HEADER TOKEN: <span className="text-slate-700">{currentUserProfile.zeroTrustToken}</span></div>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="lg:col-span-7 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between">
                <div>
                  <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
                ...
                <div className="flex-1 overflow-y-auto max-h-[220px] space-y-2 my-4 pr-1 font-mono text-[9px]">
                  {auditLogs.map((log, i) => (
                    <div key={i} className="bg-white border border-slate-850 p-2.5 rounded-xl flex items-start gap-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-[8px] text-slate-500">
                          <span className="bg-white px-1 py-0.5 rounded border border-slate-850 text-slate-600">{log.action}</span>
                          <span>ID: {log.id}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="border-t border-slate-850/60 pt-3 flex justify-end">
                  <button
                    ...
                    className="text-[10px] font-mono bg-white hover:bg-white border border-slate-200 text-slate-700 px-3 py-1.5 rounded-lg flex items-center gap-1.5 cursor-pointer transition"
                  >
          ...
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            <div className="bg-white/20 border border-slate-850 rounded-2xl p-6 flex-1 flex flex-col justify-between">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {workflows.map(wf => (
                  <div key={wf.id} className="bg-white border border-slate-850 p-4 rounded-xl flex flex-col justify-between gap-4">
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-[9px] bg-white text-slate-600 px-2 py-0.5 rounded border border-slate-850 font-mono font-bold">{wf.id}</span>
                      ...
                      <div className="text-[10px] text-slate-500 mt-1 font-mono">Trigger: <span className="text-slate-700">{wf.triggerEvent}</span></div>
                    </div>

                    <div className="border-t border-slate-850/60 pt-3 flex flex-col gap-2">
                      <div className="text-[9px] text-slate-500 font-mono">
                        Approvers: <span className="text-slate-700 font-bold">{wf.approvers?.join(" -> ")}</span>
                      </div>
                      <div className="text-[9px] text-slate-500 font-mono">
                        Last triggered: <span className="text-slate-600">{wf.lastTriggered === "Never" ? "Never" : new Date(wf.lastTriggered).toLocaleTimeString()}</span>
                      </div>

                      <button
                        onClick={() => handleTriggerWorkflow(wf.id)}
                        disabled={triggeringWorkflowId === wf.id}
                        className="w-full mt-2 bg-white hover:bg-slate-850 text-emerald-400 hover:text-emerald-700 font-bold py-1.5 border border-slate-200 rounded-lg text-[10px] flex items-center justify-center gap-1 transition cursor-pointer disabled:opacity-50"
                      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
              ...
              <div className="lg:col-span-5 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4 flex flex-col justify-between">
                ...
                <div className="space-y-3.5 my-3">
                  <div>
                    <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Select Cognitive Engine Model</label>
                    <select
                      value={aiProvider}
                      onChange={(e) => setAiProvider(e.target.value)}
                      className="w-full bg-white border border-slate-850 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500 cursor-pointer font-mono"
                    >
                  ...
                  <div>
                    <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Target Tenant Context Scope</label>
                    <select
                      value={aiTenant}
                  ...
                  <div>
                    <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Cognitive Goal Statement</label>
                    <input
                      type="text"
                      value={aiGoal}
                      onChange={(e) => setAiGoal(e.target.value)}
                      className="w-full bg-white border border-slate-850 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500 font-sans"
                    />
                  </div>
                ...
                <div className="bg-white/80 p-3 rounded-xl border border-slate-850">
                  <span className="text-[9px] font-mono text-slate-500 uppercase font-bold">Local cognitive memory stream</span>
                  <div className="space-y-1 mt-1.5 max-h-[80px] overflow-y-auto font-mono text-[8px] text-slate-600 leading-relaxed pr-1">
                    {aiMemoryPool.map((log, i) => (
                      <div key={i} className="border-b border-slate-200/60 pb-1 last:border-b-0 truncate">{log}</div>
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between min-h-[350px]">
                <div>
                  ...
                  <div className="space-y-4 my-4 animate-fade-in flex-1">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-slate-850 pb-3">
                      ...
                      <div className="flex gap-2 shrink-0">
                        <span className="text-[10px] font-mono bg-white border border-slate-850 text-slate-600 px-2.5 py-0.5 rounded">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-1.5">
                          {aiResult.agents_triggered?.map((agent: string, i: number) => (
                            <span key={i} className="text-[9px] font-mono bg-white text-emerald-700 px-2.5 py-1 rounded-lg border border-emerald-950/60 flex items-center gap-1">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-700 leading-relaxed mt-1 bg-white/60 p-3.5 rounded-xl border border-slate-850 font-sans max-h-[120px] overflow-y-auto">
                          {aiResult.summary}
                        </p>
                      </div>
                    </div>
          ...
          <div className="space-y-6 flex-1 flex flex-col animate-fade-in">
            ...
            <div className="flex border-b border-slate-200 pb-2.5 gap-6">
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition flex items-center gap-1.5 ${
                  domainSelected === "sacco" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition flex items-center gap-1.5 ${
                  domainSelected === "church" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`text-xs font-bold uppercase tracking-wider pb-1.5 transition flex items-center gap-1.5 ${
                  domainSelected === "education" ? "text-emerald-400 border-b-2 border-emerald-400" : "text-slate-500 hover:text-slate-700"
                }`}
              >
            ...
            {domainSelected === "sacco" && (
              <div className="flex flex-col lg:flex-row gap-6 flex-1">
                {/* Form Side */}
                <div className="w-full lg:w-5/12 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4">
                  <div>
                  ...
                  <form onSubmit={handleEvaluateLoan} className="space-y-3.5">
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Member ID Code</label>
                      <input
                        type="text"
                        required
                        value={memberId}
                        onChange={(e) => setMemberId(e.target.value)}
                        className="w-full bg-white border border-slate-850 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500 font-mono"
                      />
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Shares Capital Balance ($)</label>
                        <input
                          type="number"
                          required
                          value={sharesBalance}
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Requested Loan ($)</label>
                        <input
                          type="number"
                          required
                          value={requestedLoan}
                ...
                {/* Sacco loan results */}
                <div className="flex-1 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between">
                  <div>
                  ...
                  {loanResult ? (
                    <div className="space-y-4 my-4 animate-fade-in flex-1 flex flex-col justify-center">
                      ...
                      <div className="grid grid-cols-2 gap-3 bg-white p-3.5 rounded-xl border border-slate-850/80 font-mono text-[11px]">
                        <div>
                          <span className="text-slate-500">Shares Escrowed:</span>
                          <div className="text-slate-200 font-bold">{formatMoney(loanResult.shares_balance, '$')}</div>
                        </div>
                        <div>
                          <span className="text-slate-500">Allowed Credit Boundary (1:3):</span>
                          <div className="text-emerald-400 font-bold">{formatMoney(loanResult.approved_limit, '$')}</div>
                        </div>
                      </div>

                      <div className="bg-white p-4 rounded-xl border border-slate-850">
                        <div className="text-[9px] font-mono text-slate-500 uppercase mb-1 font-bold">Lending Engine Mathematical Proof</div>
                        <p className="text-xs text-slate-700 leading-relaxed font-sans">{loanResult.reasoning}</p>
                      </div>
                    </div>
                  ) : (
                    <div className="text-center py-16 text-xs text-slate-500 italic flex-1 flex items-center justify-center">
              ...
              <div className="flex flex-col lg:flex-row gap-6 flex-1">
                ...
                <div className="w-full lg:w-5/12 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4">
                  ...
                  <form onSubmit={handleChurchPost} className="space-y-3.5">
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Donor Full Name</label>
                      <input
                        type="text"
                        required
                        value={donorName}
                        onChange={(e) => setDonorName(e.target.value)}
                        className="w-full bg-white border border-slate-850 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-emerald-500"
                      />
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Fundraising Diocese / Cluster</label>
                        <input
                          type="text"
                          required
                          value={dioceseName}
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Donation Amount ($)</label>
                        <input
                          type="number"
                          required
                    ...
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Target FAAP Receipt Account</label>
                      <select
                ...
                <div className="flex-1 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between">
                  ...
                  <div className="bg-white border border-slate-850/60 rounded-xl p-4 my-4 flex-1 flex flex-col justify-center">
                    {churchMessage ? (
              ...
              <div className="flex flex-col lg:flex-row gap-6 flex-1">
                ...
                <div className="w-full lg:w-5/12 bg-white/20 p-5 rounded-2xl border border-slate-850 space-y-4">
                  ...
                  <form onSubmit={handleEduPost} className="space-y-3.5">
                    <div>
                      <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Student ID Code</label>
                      <input
                        type="text"
                        required
                        value={studentId}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">Tuition Fees Reconciled ($)</label>
                        <input
                          type="number"
                          required
                          value={tuitionAmount}
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-slate-600 uppercase mb-1">FAAP Cash Receipt Account</label>
                        <select
                ...
                <div className="flex-1 bg-white/40 p-5 rounded-2xl border border-slate-850 flex flex-col justify-between">
                  ...
                  <div className="bg-white border border-slate-850/60 rounded-xl p-4 my-4 flex-1 flex flex-col justify-center font-mono">
                    {eduMessage ? (
                      <div className="space-y-3.5 text-center animate-fade-in">
                        <CheckCircle2 className="h-10 w-10 text-emerald-400 mx-auto" />
