...
async function startServer() {
  ...
  app.get("/api/tenants", validateSession, requireRole(["SecOps_Administrator"]), (req, res) => {
    try {
      const baseTenants = [
        { id: "sacco-zambia-hq", name: "SACCO Zambia HQ Node", tier: "Enterprise Platinum", status: "Active", created: "2026-01-10", userCount: 42, volume: "$182,500" },
        { id: "church-uganda-diocese", name: "Church of Uganda Diocese Cluster", tier: "Non-Profit Standard", status: "Active", created: "2026-03-15", userCount: 18, volume: "$45,000" },
        { id: "education-kenya-board", name: "Kenya Education Board Node", tier: "Government Scale", status: "Active", created: "2026-05-20", userCount: 31, volume: "$120,000" }
      ];
  ...
  app.get("/api/v1/domains", (req, res) => {
    try {
      ...
      // Default standard domains if registry empty
      const defaultDomains = [
        { id: "sacco", name: "SACCO ERP", status: "Active", price: 299 },
        { id: "church", name: "Church ERP", status: "Active", price: 199 },
        { id: "ngo", name: "NGO ERP", status: "Active", price: 140 },
        { id: "alumni", name: "Alumni ERP", status: "Active", price: 99 }
      ];
