...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error("JUMO Sovereign ErrorBoundary caught error:", error, errorInfo);
  }
      ...
      return (
        <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-slate-800 border border-slate-700 p-8 rounded-3xl shadow-2xl text-center space-y-4">
            ...
            <h1 className="text-xl font-black tracking-tight">{this.props.fallbackTitle || "Sovereign Operational Interruption"}</h1>
