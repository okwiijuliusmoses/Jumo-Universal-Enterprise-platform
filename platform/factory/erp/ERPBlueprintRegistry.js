...
export const ERPBlueprintRegistry = {
  ...
  blueprints: [
    ...
    {
      id: "infrastructure-utilities-erp",
      name: "Infrastructure & Utilities ERP Ecosystem",
      category: "Infrastructure ERP",
      configurableScope: ["Energy Grid", "Water & Sanitation", "Utility Authority"],
      capabilities: ["Grid Management", "Utility Distribution", "Consumer Billing", "Infrastructure Maintenance"],
      generationRules: { configurable: true }
    },

    {
      id: "national-security-erp",
      name: "National Security & Emergency Services ERP Ecosystem",
      category: "Security ERP",
      configurableScope: ["Emergency Response", "Disaster Management", "Security Services"],
      capabilities: ["Incident Response", "Resource Dispatch", "Emergency Planning", "Field Operations"],
      generationRules: { configurable: true }
    }
