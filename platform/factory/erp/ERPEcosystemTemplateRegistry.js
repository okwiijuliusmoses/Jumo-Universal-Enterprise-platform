...
export class ERPEcosystemTemplateRegistry {
  constructor() {
    this.templates = [
      ...
      {
        id: "energy-grid-erp",
        ecosystemId: "infrastructure-utilities-erp",
        name: "Energy Grid Management ERP",
        description: "National energy generation, transmission, and distribution grid management.",
        portals: ["Energy Director Portal", "Grid Operations Portal", "Billing & Consumer Portal"],
        departments: ["Energy Directorate", "Operations & Maintenance Division", "Finance & Billing Section"],
        modules: ["Energy Grid Registry", "Load Distribution Controller", "Billing & Payment Engine"],
        layers: ["National Grid Oversight", "Operational Hubs"],
        components: ["Grid Load Monitor", "Billing Ledger"],
        branches: ["National HQ", "Regional Substation"],
        workflows: ["Grid Maintenance Approval", "Billing Reconciliation Path"]
      },
      {
        id: "water-sanitation-erp",
        ecosystemId: "infrastructure-utilities-erp",
        name: "Water & Sanitation Authority ERP",
        description: "Municipal water supply, sewage treatment, and sanitation infrastructure manager.",
        portals: ["Authority Director Portal", "Plant Operations Portal", "Citizen Billing Portal"],
        departments: ["Authority Directorate", "Treatment Plant Operations", "Customer Service & Billing"],
        modules: ["Water Quality Registry", "Treatment Plant Controller", "Customer Water Billing"],
        layers: ["National Governance", "Utility Operations"],
        components: ["Water Quality Monitor", "Billing Ledger"],
        branches: ["National HQ", "Regional Treatment Plant"],
        workflows: ["Water Treatment Approval", "Billing Reconciliation Path"]
      },
      {
        id: "national-emergency-erp",
        ecosystemId: "national-security-erp",
        name: "National Emergency & Disaster Response ERP",
        description: "Coordinated disaster response, search and rescue, and emergency resource allocation.",
        portals: ["Director of Operations Portal", "Emergency Response Team Portal", "Resource Coordination Portal"],
        departments: ["Operations Directorate", "Response Team Division", "Logistics & Resources Section"],
        modules: ["Disaster Registry", "Emergency Resource Dispatch", "Incident Response Tracker"],
        layers: ["National Governance", "Field Response Network"],
        components: ["Resource Monitor", "Incident Tracker"],
        branches: ["National HQ", "Regional Response Hub"],
        workflows: ["Disaster Response Initiation", "Logistics Disbursement Path"]
      }
    ];
      ...
      blueprint.configurableScope.forEach(scope => {
        ...
        if (!this.templates.find(t => t.id === templateId)) {
          this.templates.push({
            ...
            name: `${scope} ERP`,
            description: `Automated enterprise platform for ${scope}.`,
  ...
  isDefaultTemplate(id) {
    ...
    return [
      ...
      "energy-grid-erp", "water-sanitation-erp", "national-emergency-erp"
    ].includes(id);
  }
