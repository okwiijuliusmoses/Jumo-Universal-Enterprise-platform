...
export class ERPEcosystemTemplateRegistry {
    ...
    this.templates = [
      {
        ...
        defaultPortals: ["Student Portal", "Faculty Portal", "Administration Portal", "Academic Registrar Portal", "Bursar Portal", "Research Portal"],
  ...
  getBlueprint(id) {
    const template = this.templates.find(t => t.id === id || t.blueprintId === id);
    if (template) {
      return template;
    }
