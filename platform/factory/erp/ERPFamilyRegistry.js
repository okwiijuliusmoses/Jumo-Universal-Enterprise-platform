...
export class ERPFamilyRegistry {
  constructor() {
    this.families = [
      ...
      {
        id: "infrastructure-family",
        name: "Infrastructure & Utilities ERP Family",
        code: "INF",
        description: "Management for energy grids, water supply, sanitation, and public utilities.",
        sectors: ["Energy", "Water", "Sanitation", "Utilities"],
        templates: ["infrastructure-energy-template", "infrastructure-water-template"]
      },
      {
        id: "national-security-family",
        name: "National Security ERP Family",
        code: "SEC",
        description: "Emergency response, disaster management, and security infrastructure services.",
        sectors: ["Emergency Services", "Disaster Relief", "Security"],
        templates: ["security-emergency-template", "security-disaster-template"]
      }
    ];
  }
