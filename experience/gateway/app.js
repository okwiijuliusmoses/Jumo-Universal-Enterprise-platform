...
import { publicTemplate, loginTemplate, gatewayTemplate } from "./index.js";
...
if (savedRuntime) {
  try {
    ...
    window.state.activeErpInstanceId = runtime.erpId;
    ...
    window.state.session = {
      ...
      organization: runtime.erpName || runtime.name,
      tenantId: "system",
      activeErpInstance: {
        instanceId: runtime.erpId,
        name: runtime.erpName || runtime.name,
    ...
    window.state.deployedInstitution = {
      id: runtime.tenantId || "system",
      name: runtime.erpName || runtime.name || "Enterprise Platform",
      portals: window.state.portals
    };
  } catch (e) {
