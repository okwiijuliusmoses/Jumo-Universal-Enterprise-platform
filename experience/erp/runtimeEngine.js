...
export const PORTALS_MAP = {
  ...
  "standalone-alumni": [
    { id: "alum-exec", name: "Global Alumni Executive Council Portal", desc: "Global president, constitutional governance, and trustees." },
    { id: "alum-membership", name: "Global Alumni Membership & Identity Portal", desc: "Lifelong member profiles and bio-data registrations." },
    { id: "alum-chapters", name: "Global Alumni Chapters Governance Portal", desc: "Regional and diaspora chapter networks coordination." },
    { id: "alum-career", name: "Alumni Career & Professional Network Portal", desc: "Graduate placements, resume indexing, and mentorship pairings." },
    { id: "alum-advancement", name: "Alumni Engagement & Relations Portal", desc: "Lifelong institutional liaison and alumni relations." },
    { id: "alum-fundraising", name: "Global Fundraising & Development Portal", desc: "Campaign tracking, donor contributions, and donor records." },
    { id: "alum-endowment", name: "Alumni Endowment & Treasury Management Portal", desc: "Secure asset management, accounting, and financial ledger." },
    { id: "alum-business", name: "Alumni Enterprise & Business Network Portal", desc: "Alumni-owned corporate directory and business collaborations." },
    { id: "alum-investment", name: "Alumni Investment & Venture Network Portal", desc: "Crowdfunded investments, equity shares, and capital payouts." },
    { id: "alum-sacco", name: "Alumni Financial Services & SACCO Portal", desc: "Credit cooperative, emergency loans, and welfare benefits." },
    { id: "alum-comm", name: "Alumni Communications Portal", desc: "Newsletter dispatches, press releases, and alumni magazines." },
    { id: "alum-events", name: "Global Alumni Events Portal", desc: "Annual homecoming, reunions, webinars, and check-ins." },
    { id: "alum-research", name: "Alumni Research & Analytics Portal", desc: "Post-graduate research, tracer analytics, and industry surveys." },
    { id: "alum-digital", name: "Alumni Digital Identity Services Portal", desc: "Digital member IDs, document verifications, and online portals." },
    { id: "alum-audit", name: "Alumni Compliance & AEGIS Audit Portal", desc: "Operational risk audits, treasury reconciliations, and AEGIS immutable logs." }
  ],
  "standalone-clan": [
